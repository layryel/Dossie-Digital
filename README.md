...
Esta branch centraliza materiais relacionados às atividades desenvolvidas junto à Igreja Messiânica Mundial do Brasil, incluindo conteúdos institucionais, produções de comunicação e projetos realizados nesse contexto. Os materiais refletem experiências ligadas à comunicação organizacional e produção de conteúdo.
