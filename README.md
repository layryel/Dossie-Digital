...
Esta branch reúne publicações produzidas ao longo da minha trajetória acadêmica e profissional, incluindo conteúdos institucionais, produções jornalísticas e materiais desenvolvidos para comunicação organizacional. Aqui estão organizados textos, artigos, produções editoriais e conteúdos publicados em diferentes contextos.
