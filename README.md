...
Esta branch reúne atividades desenvolvidas durante minha trajetória educacional no curso de formação profissional no Instituto Saber, incluindo produções acadêmicas, exercícios e materiais relacionados ao processo de aprendizagem. Os conteúdos refletem evolução técnica, organização e construção de conhecimento.
